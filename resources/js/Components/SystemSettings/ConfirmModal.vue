          ...
          >
            <DialogPanel class="relative transform overflow-hidden rounded-xl bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              <div class="sm:flex sm:items-start">
                ...
                >
                  <AlertTriangleIcon v-if="type === 'danger'" class="h-6 w-6 text-red-600" />
                  <InfoIcon v-else class="h-6 w-6 text-blue-600" />
                </div>
              ...
              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                ...
                <button
                  type="button"
                  class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto transition-all duration-300"
                  @click="closeModal"
                >
                  {{ cancelText }}
                </button>
